...
| WinUI product-shell foundation | Deployment preview done | Locked minimal Windows App SDK/C++/WinRT component graph; unpackaged self-contained payload; Home/Advanced/Diagnostics over simulated states; single-instance activation; close-to-tray and bounded exit; separate lifecycle mutex; installer/update integration; Alpha remains the normal UI until broker-backed cutover |
