...
| Voice authorization and privacy | Automated implementation complete | Reciprocal acknowledged grants after PeerValidated; current nonce; local-only PTT/hard mute/device authority; capture closes on release, revoke, disconnect, endpoint loss, configuration change, and shutdown; reconnect requires fresh PTT |
